  ...
  return (
    <div className="board">
      ...
      <div className="board__footer">
        <div className="card result bg-blue">
          <p className="text-light"> x {checkUser("x")}</p>
          <strong className="text-2xlg">{ties.x}</strong>
        </div>
        <div className="card result bg-light">
          <p className="text-light">ties</p>
          <strong className="text-2xlg">{ties.x + ties.o}</strong>
        </div>
        <div className="card result bg-yellow">
          <p className="text-light"> o {checkUser("o")}</p>
          <strong className="text-2xlg">{ties.o}</strong>
        </div>
      </div>
    </div>
  );
